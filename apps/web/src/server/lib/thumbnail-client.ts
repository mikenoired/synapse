...
export class ThumbnailClient {
	...
	private async initializeClient() {
		try {
			...
			const protoPath = path.resolve(process.cwd(), "../../services/thumbnail-service/proto/thumbnail.proto");
			...
			this.grpcClient = new thumbnailProto.ThumbnailService(this.endpoint, grpc.credentials.createInsecure());
