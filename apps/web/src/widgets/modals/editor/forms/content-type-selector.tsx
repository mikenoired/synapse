...
const contentTypes = [
	{ key: "note" as const, icon: FileText, label: "Заметка" },
	{ key: "media" as const, icon: ImageIcon, label: "Медиа" },
	{ key: "audio" as const, icon: Music2, label: "Аудио" },
	{ key: "link" as const, icon: Link, label: "Ссылка" },
	{ key: "todo" as const, icon: ListChecks, label: "Задачи" },
	{ key: "doc" as const, icon: FileUp, label: "Документы" },
];
...
export function ContentTypeSelector({
	...
	return (
		<div className="p-4 border-b flex flex-row items-center justify-between flex-shrink-0">
