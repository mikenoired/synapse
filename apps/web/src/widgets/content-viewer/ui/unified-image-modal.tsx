...
export function UnifiedMediaModal({
  ...
  return (
    <Modal
      ...
      className={cn(
        'max-w-none w-screen h-screen rounded-none bg-transparent',
...
function MiniatureCarousel({ gallery, currentIndex, setDirection, setCurrentIndex, isHovered }: {
  ...
  return (
    ...
    >
      {gallery.filter(media => media.url).map((media, index) => {
