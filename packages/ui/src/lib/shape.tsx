...
// Backwards-compatible static shape used by components that intentionally do
// not follow the ambient ShapeProvider (the pre-context default was rounded).
export const shape = shapeMap.rounded;
