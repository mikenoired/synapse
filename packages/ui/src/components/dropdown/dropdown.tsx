					...
					<motion.div
						...
						<DropdownContext.Provider value={contentCtx}>
							<div
								...
								className={cn(
									`${surfaceClass} relative flex flex-col gap-0.5 w-72 max-w-full min-w-[var(--radix-dropdown-menu-trigger-width)] max-h-[min(480px,var(--radix-dropdown-menu-content-available-height))] overflow-y-auto p-1 select-none outline-none`,
									shape.container,
									className
								)}>
								<AnimatePresence>
